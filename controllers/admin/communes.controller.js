...
const findAll = async (req, res) => {
    try {
        ...
        if (!orderColumn || !sortModel) {
            orderColumn = sortColumns.commune_info.fields.COMMUNE_ID
            sortModel = {
                model: 'commune_info',
                as: sortColumns.commune_info
            }
        }
        // ordering
        if (sortOrder == 1) {
        ...
        const result = await Syst_communes.findAndCountAll({
            limit: parseInt(rows),
